...
class VeRi(BaseImageDataset):
    ...
    def __init__(self, root='', verbose=True, **kwargs):
        ...
        self.train_dir = osp.join(self.dataset_dir, 'image_train/image_train_vertical')
        self.query_dir = osp.join(self.dataset_dir, 'image_query/image_query_vertical')
        self.gallery_dir = osp.join(self.dataset_dir, 'image_test/image_test_vertical')
