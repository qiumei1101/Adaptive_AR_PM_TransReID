...
def main(args):
    ...
    for img_ in img_path_list:
        ...
        with torch.no_grad():
            ...
            weight1 = 1.3 if abs(model_1_ar - ar) <= 0.4 else 1.0 if abs(model_1_ar - ar) <= 0.7 else 0.9
            weight2 = 0.9 if abs(model_2_ar - ar) <= 0.4 else 1.0 if abs(model_2_ar - ar) <= 0.7 else 0.9
            weight3 = 0.5 if abs(model_3_ar - ar) <= 0.4 else 1.0 if abs(model_3_ar - ar) <= 0.7 else 0.9
...
if __name__ == "__main__":
    ...
    parser.add_argument("--size_test_1", type=list, default=[384, 384], help="Input size for model 1")
    parser.add_argument("--size_test_2", type=list, default=[384, 308], help="Input size for model 2")
    parser.add_argument("--size_test_3", type=list, default=[384, 396], help="Input size for model 3")
    ...
    parser.add_argument("--model_2_ar", type=float, default=308/384, help="Aspect ratio for model 2")
    parser.add_argument("--model_3_ar", type=float, default=396/384, help="Aspect ratio for model 3")
